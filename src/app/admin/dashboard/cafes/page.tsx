    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-4xl font-bold text-white mb-2 underline decoration-purple-500/50 underline-offset-8">Manage Cafes & Dining</h1>
            <p className="text-gray-400">View and manage all cafe and restaurant listings</p>
          </div>
            ...
            >
              <div className="relative h-48 bg-slate-800 overflow-hidden">
                ...
                <div className="absolute top-3 right-3 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity translate-y-2 group-hover:translate-y-0 duration-300">
                  ...
                  <button 
                    onClick={() => handleDelete(cafe.slug)}
